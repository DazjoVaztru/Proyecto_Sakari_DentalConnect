...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:25px;">
    <div style="position:relative;width:350px;">
        <input type="text" placeholder="Buscar..." style="width:100%;padding:12px 25px;border-radius:50px;border:1px solid #bcebf5;background:#e0fbfc;outline:none;">
...
<div id="modal-new-treatment" class="modal-overlay">
    <div class="modal-glass" style="max-width:500px;">
        ...
        <form action="{{ route('tratamientos.store') }}" method="POST">
            ...
            <button type="submit" class="ghost-btn" style="width:100%;background:var(--primary-color);color:white;">Guardar</button>
        </form>
    </div>
</div>
...
<div id="modal-edit-treatment" class="modal-overlay">
    <div class="modal-glass" style="max-width:500px;">
        ...
        <form id="form-edit" method="POST">
            ...
            <button type="submit" class="ghost-btn" style="width:100%;background:#f59e0b;color:white;">Actualizar</button>
        </form>
    </div>
</div>
