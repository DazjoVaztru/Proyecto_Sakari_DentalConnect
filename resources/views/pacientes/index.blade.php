...
@section('scripts')
    ...
    <script>
        ...
        function eliminarPaciente() {
            ...
            Swal.fire({
                title: '¡Atención!',
                text: `Estás a punto de ELIMINAR por completo al paciente ${currentPaciente.nombre}. Esta acción eliminara por completo los datos del paciente ¿Deseas Continuar?`,
                icon: 'error',
                showCancelButton: true,
